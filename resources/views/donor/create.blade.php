    ...
    <div class="card-body">
        ...
        <form method="POST"action="{{route('donor.store')}}">
            ...
            <div class="input-group">
                <input class="input--style-2" type="text" placeholder="middle name" name="middle_name">
            </div>
            <div class="input-group">
            ...
            {{-- <div class="form-group mt-3 ">
                <div class="rs-select2 js-select-simple select--no-search">
                    <select name="hospital_id" id="centre"> 
                        <option selected disabled>means</option>
            ...
            <div class="row row-space">
                ...
                <div class="row row-space">
                    <div class="col-12 mt-4">
                        <div class="input-group">
                            <input class="input--style-2" type="text" placeholder="Tribe" name="tribe">
                        </div>
                    </div>
