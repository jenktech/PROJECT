        ...
        <div class="card-body">
            ...
            <form method="POST"action=>
                ...
                <div class="input-group">
                    <input class="input--style-2" type="hidden" placeholder="unit" name="unit" id="unit"required>
                </div>
            
                <div class="input-group">
                    <input class="input--style-2" type="hidden" placeholder="blood_group" name="blood_type" id="blood_type"required>
                </div>
